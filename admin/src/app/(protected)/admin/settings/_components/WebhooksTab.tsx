        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <label className="block">
            ...
            <select
              ...
              className="w-full rounded-md border border-slate-200 bg-white/[0.85] px-3 py-2 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-brand-400/[0.4] dark:border-white/10 dark:bg-[#252930] dark:text-slate-100"
            >
          ...
          <label className="block">
            ...
            <input
              ...
              className="w-full rounded-md border border-slate-200 bg-white/[0.85] px-3 py-2 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-brand-400/[0.4] dark:border-white/10 dark:bg-white/[0.055] dark:text-slate-100"
            />
          </label>
