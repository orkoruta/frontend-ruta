...
/**
 * Muestrario del design system. Vivía en `/` y era lo que veía cualquiera que
 * entrara a la raíz del storefront; se movió aquí para dejar la raíz a la
 * pantalla de bienvenida, sin perder la referencia visual de los componentes.
 */
